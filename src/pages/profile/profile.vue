<template>
  <section class="profile">
    <div class="profile__main-info">
      <img src="~shared/assets/images/temp-home-logo.png" alt="user" class="profile__main-info-img">

      <div class="profile__main-info-text">
        <div class="profile__main-info-name">{{ userData.surname }} {{ userData.name }}</div>
    ...
    <div class="profile__sub-info">
      <div class="profile__sub">
        <img src="~shared/assets/images/location.png" alt="location" class="profile__sub-img">
        <div class="profile__sub-text">{{ userData.location }}</div>
      </div>

      <div class="profile__sub" v-if="userData.subInfo">
        <img src="~shared/assets/images/check.png" alt="check" class="profile__sub-img">
    ...
    <ui-reviews :reviews="userData.reviews" class="profile__dynamic-info"/>
    <ui-vacancies :vacancies="userData.vacancies" class="profile__dynamic-info"/>
    <ui-button :text="btnText"/>
    <ui-button :text="userData.favorites" :classMod="classMod"/>
  </section>
</template>
  ...
  data: () => ({
    userData: {
      ...
      vacancies: [
        ...
        {time: "Четверг 12:00-17:00", tasks: "Сортировка огуречной...", id: 2},
        {time: "23 июля 14:00-20:00 ", tasks: "В ростовом костюме огурца...", id: 3},
      ],
